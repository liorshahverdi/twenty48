...
public class Grid {
	...
	public void setTile(int r, int c, int val) {
		mat[r][c] = val;
	}
	...
	public void shiftRight() {// [row3][colk] -> [rowk][col3]
		for (int k = 0; k < 4; k++) {
			if (mat[k][3] != 0) {
				if (mat[k][2] != 0) {
					if (mat[k][3] == mat[k][2]) {
	...
	public void shiftLeft() {// [row0][colk] -> [rowk][col0]
		for (int k = 0; k < 4; k++) {
			if (mat[k][0] != 0) {
				if (mat[k][1] != 0) {
					if (mat[k][0] == mat[k][1]) {
